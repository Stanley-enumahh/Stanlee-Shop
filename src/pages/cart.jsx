import { PhoneData } from "../assets/products/products"
import { ShopContext } from "../context/shopContext";
import React, { useContext } from "react";
import { CartStuff } from "../assets/cartStuff";
            ...
            <div className="md:relative md:h-full md:w-[30%] h-[30%] shadow-md bg-[#084c61] text-white flex flex-col items-center">
               ...
               <div className="md:gap-0 gap-3 md:mt-8 h-full flex flex-col text-center items-center justify-between w-full">
                   ...
                   <div className="flex md:flex-col flex-row items-center md:w-[80%] w-[90%] gap-3 mb-4">
                        ...
                        <Link className=" flex flex-row justify-between md:w-full w-[50%] text-sm" to="/">
                            <button className="bg-gray-900 hover:bg-gray-800 duration-150 transition-all w-full py-2 rounded flex flex-row items-center justify-center gap-2 text-sm"><BsArrowLeft/>back to shop
                            </button>
                        </Link>

                        
                          {totalAmount > 0? 
                            <button className=" bg-indigo-600 md:w-full w-[50%] py-2 rounded hover:bg-indigo-500 transition-all duration-150 text-sm">check out</button>: <h1>your cart is empty</h1>
                            }
